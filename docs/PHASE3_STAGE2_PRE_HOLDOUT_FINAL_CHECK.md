# Phase 3 Stage 2 — PRE-HOLDOUT METRIC INTEGRITY FINAL CHECK

- **日期**：2026-08-28 17:24 ｜ git `af872dd` ｜ 判定：GPU/Vision PASS；Gate = PASS WITH METRIC-INTEGRITY FIX（本报告核验）
...
- **VISION_MODEL_BUNDLE_V1_1_LOCK.json** 已生成：
  - bundle_id=VISION_MODEL_BUNDLE_V1_1 ｜ git_code_commit=`af872dd80adf`
  - static=google/siglip-base-patch16-224（en-v1）｜ prompt_hash=`ccf0b2ae6278`
  - field_routing=FIELD_ROUTING_V1 ｜ dictionary=V2.1 ｜ calibration_manifest_hash=`aa6c2a8d4577`
...
- **manifest_sha256 = `31ae951d99f0e792`**
...
7. Bundle lock hash？ → **`6c2ce081b9d2a1be`**
8. Holdout manifest hash？ → **`31ae951d99f0e792`**
